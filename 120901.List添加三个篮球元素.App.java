...
public class App {
    ...
    public App() {
        ...
        label_list.get(0).setBounds(0,0,600,300);
        myPanel.add(label_list.get(0));


        label_list.get(1).setIcon(new ImageIcon(imgURL));
        label_list.get(1).setBounds(65,0,600,300);
        myPanel.add(label_list.get(1));


        label_list.get(2).setIcon(new ImageIcon(imgURL));
        label_list.get(2).setBounds(129,0,600,300);
        myPanel.add(label_list.get(2));


        //        删除
//        myPanel.remove( label_list.get(0));  120901.List添加三个篮球元素.App.java
